defmodule ChatlotleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ChatlotleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ChatlotleWeb.Gettext, "errors", msg, opts)
    end
  end
